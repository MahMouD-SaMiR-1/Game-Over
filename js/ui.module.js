                        ...
                        <div data-id="${data[i].id}" class="card h-100 bg-transparent" role="button">
                            <div class="card-body">
                                ...
                                <figcaption>
                                    ...
                                    <p class="card-text small text-center text-white opacity-50">${data[i].short_description}</p>
                                </figcaption>
                            </div>
                            <footer class="card-footer text-white small hstack justify-content-between">
...
displayDetails(data){
    const detailsBox = `<div class="col-md-4">
                ...
                <div class="col-md-8">
                    ...
                    <a class="btn btn-outline-warning" target="_blank" href="${data.game_ur}">Show Game</a>
